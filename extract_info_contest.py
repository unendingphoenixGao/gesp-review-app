        ...
        "lessons": [
            {
                ...
                "links": [
                    {"label": "OI Wiki：关联式容器", "url": "https://oi-wiki.org/lang/csl/associative-container/"},
                    {"label": "OI Wiki：pair", "url": "https://oi-wiki.org/lang/csl/pair/"},
                    {"label": "C语言中文网：map 容器入门", "url": "https://c.biancheng.net/view/7173.html"},
                ],
            },
            {
                ...
                "links": [
                    {"label": "OI Wiki：容器适配器 stack/queue", "url": "https://oi-wiki.org/lang/csl/container-adapter/"},
                ],
            },
            {
                "title": "BFS / DFS 搜索",
                ...
                "links": [
                    {"label": "OI Wiki：BFS（搜索）", "url": "https://oi-wiki.org/search/bfs/"},
                    {"label": "OI Wiki：DFS（搜索）", "url": "https://oi-wiki.org/search/dfs/"},
                ],
            },
            {
                "title": "前缀和",
                ...
                "links": [
                    {"label": "OI Wiki：前缀和 & 差分", "url": "https://oi-wiki.org/basic/prefix-sum/"},
                ],
            },
            {
                "title": "排序与结构化记录",
                ...
                "links": [
                    {"label": "OI Wiki：序列式容器 vector", "url": "https://oi-wiki.org/lang/csl/sequence-container/"},
                    {"label": "OI Wiki：pair", "url": "https://oi-wiki.org/lang/csl/pair/"},
                ],
            },
        ],
